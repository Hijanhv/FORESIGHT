        ...
        <form onSubmit={handleSubmit} className="flex w-full items-center gap-2">
          ...
          {fixtureId ? (
            <button
              type="button"
              onClick={handleClear}
              className="rounded-full border border-line px-4 py-2 font-mono text-[11px] text-muted transition-colors hover:border-hot/50 hover:text-hot"
            >
              clear
            </button>
          ) : (
            <button
              type="submit"
              className="rounded-full border border-cool/50 bg-cool/10 px-4 py-2 font-mono text-[11px] text-cool transition-colors hover:bg-cool/20"
            >
              watch
            </button>
          )}
